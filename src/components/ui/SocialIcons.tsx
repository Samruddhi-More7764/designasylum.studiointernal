/**
 * Shared social-media glyphs used across footer variants (Homepage, Client
 * Hub, Case Study). Pure SVG, no external icon library.
 */
export function SocialLinkedIn(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export function SocialInstagram(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
...
export function SocialYouTube(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
